...
struct MuxyApp: App {
    ...
    @State private var frecencyStore: FrecencyStore
    ...
    init() {
        ...
        let frecencyStore = FrecencyStore(
            persistence: environment.frecencyPersistence
        )
        ...
        _frecencyStore = State(initialValue: frecencyStore)
